...
​                   ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image007.gif)
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image010.gif)                                           （2) 查找订单功能：输入订单号实现对订单查询操作。能实现对订单号格式的校验，只能是数字格式，并且非空，若格式错误会弹窗提示，当订单不存在时候也会弹出错误提示。

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image012.gif)                                        

（3） 删除订单功能：输入要删除的订单号，完成对订单的删除。并且可以撤回删除操作。当想恢复上一次删除的内容时，单击撤回删除按钮即可实现。能实现对订单号格式的校验，只能是数字格式，并且非空，若格式错误会弹窗提示，当订单不存在时候也会弹出错误提示                                    

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image015.gif)                  

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image016.gif)                                   

（4） 修改功能：使用了JTable,直接双击表格文本框即可完成修改和保存。                                     ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image019.gif)                 

 ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image020.gif)                                                                 
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image022.gif)                                    
## 组合模式
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image024.gif)                                     
## 备忘录模式
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image026.gif)                                 
## 代理模式
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image028.gif)                                     
## 单例模式
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image030.gif)                                                           3   
...
![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image034.gif)                                                                      增加新订单：

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image036.gif)                                              返回主界面，在最后一行能找到新增的订单                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image038.gif)                

查看商品菜单 

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image040.gif)

未选择客户类型时候：                        

  ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image042.gif)                 

未确认选择情况下撤回选择                                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image045.gif)              

未确认选择情况下提交订单    

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image046.gif)                                         

存在未提交订单情况下点击确认选择：                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image048.gif)                         

查找订单：                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image050.gif)                                           



订单号不存在，或者订单格式有问题：                                   

  ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image053.gif)        

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image054.gif)                                                 

删除订单：                            

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image057.gif)                                     

订单号不存在，或者订单格式有问题：                                    

 ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image060.gif)        

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image061.gif)                                     

 撤回删除：  执行撤回前：                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image063.gif)                            

执行撤回后：                       

  ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image065.gif)                                  

不存在删除操作时：                         

![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image067.gif)                                     

修改订单：单击修改订单显示                        

 ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image069.gif)                               

直接在表格上即可进行修改，修改将自动保存                         ![img](Java五种设计模式实现奶茶订单生成系统小DEMO/clip_image071.gif)                               
